...
function render_student(index) {
	...
	n_div.html("<img src='image/" + stu.num + ".png'></img><p>" + stu.name + "</p><p>" + stu.num + "</p><div class=\"p_mask\"></div><div class=\"p_tip\">缺席</div>").appendTo('#c_PList');
